...
RUN mkdir -p /var/tmp && wget -q -nc --no-check-certificate -P /var/tmp http://mvapich.cse.ohio-state.edu/download/mvapich/gdr/2.3/mofed4.2/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm && \
    cd / && rpm2cpio /var/tmp/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm | cpio -id && \
    ...
    rm -rf /var/tmp/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm
ENV LD_LIBRARY_PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/lib64:$LD_LIBRARY_PATH \
    PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/bin:$PATH \
...
RUN yum install -y \
    ...
    rm -rf /var/cache/yum/*
RUN mkdir -p /var/tmp && wget -q -nc --no-check-certificate -P /var/tmp http://mvapich.cse.ohio-state.edu/download/mvapich/gdr/2.3/mofed4.2/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm && \
    rpm --install --nodeps /var/tmp/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm && \
    (test -f /usr/bin/bash || ln -s /bin/bash /usr/bin/bash) && \
    ln -s /usr/local/cuda/lib64/stubs/nvidia-ml.so /usr/local/cuda/lib64/stubs/nvidia-ml.so.1 && \
    rm -rf /var/tmp/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm
ENV LD_LIBRARY_PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/lib64:$LD_LIBRARY_PATH \
...
RUN mkdir -p /var/tmp && wget -q -nc --no-check-certificate -P /var/tmp http://mvapich.cse.ohio-state.edu/download/mvapich/gdr/2.3/mofed4.2/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm && \
    ...
    ln -s /usr/local/cuda/lib64/stubs/nvidia-ml.so /usr/local/cuda/lib64/stubs/nvidia-ml.so.1 && \
    rm -rf /var/tmp/mvapich2-gdr-mcast.cuda9.0.mofed4.2.gnu4.8.5-2.3-1.el7.x86_64.rpm && \
    echo "/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/lib64" >> /etc/ld.so.conf.d/hpccm.conf && ldconfig
ENV PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/bin:$PATH \
    PROFILE_POSTLIB="-L/usr/local/cuda/lib64/stubs -lnvidia-ml"''')
...
RUN apt-get update -y && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
        ...
        libgfortran3 && \
    rm -rf /var/lib/apt/lists/*
COPY --from=0 /opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5 /opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5
ENV LD_LIBRARY_PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/lib64:$LD_LIBRARY_PATH \
    PATH=/opt/mvapich2/gdr/2.3/mcast/no-openacc/cuda9.0/mofed4.2/mpirun/gnu4.8.5/bin:$PATH''')
