...
COPY --from=0 /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/libgomp.so \
    /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/libiomp5.so \
    /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/libomp.so \
    /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/libflang.so \
    /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/libflangrti.so \
    /opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib/
COPY --from=0 /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_arm-linux-compiler_20.3_aarch64-linux/lib/libamath.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_arm-linux-compiler_20.3_aarch64-linux/lib/libamath_dummy.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_arm-linux-compiler_20.3_aarch64-linux/lib/libastring.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_arm-linux-compiler_20.3_aarch64-linux/lib/
COPY --from=0 /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_gcc_9.2.0_aarch64-linux/lib/libamath.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_gcc_9.2.0_aarch64-linux/lib/libamath_dummy.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_gcc_9.2.0_aarch64-linux/lib/libastring.so \
    /opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_gcc_9.2.0_aarch64-linux/lib/
ENV LD_LIBRARY_PATH=/opt/arm/arm-linux-compiler-20.3_Generic-AArch64_RHEL-7_aarch64-linux/lib:/opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_arm-linux-compiler_20.3_aarch64-linux/lib:/opt/arm/armpl-20.3.0_Generic-AArch64_RHEL-7_gcc_9.2.0_aarch64-linux/lib:$LD_LIBRARY_PATH''')
