...
from helpers import aarch64, centos, docker, ubuntu, x86_64, zen2
...
r'''# NVIDIA HPC SDK version 25.11
...
RUN mkdir -p /usr/share/keyrings && \
    ...
    apt-get update -y && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
        nvhpc-25-11-cuda-multi && \
    rm -rf /var/lib/apt/lists/*
ENV CPATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nvshmem/include:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nccl/include:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/extras/qd/include/qd:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/math_libs/include:$CPATH \
    LD_LIBRARY_PATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nvshmem/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nccl/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/math_libs/lib64:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/cuda/lib64:$LD_LIBRARY_PATH \
    MANPATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/man:$MANPATH \
    PATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nvshmem/bin:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/nccl/bin:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/profilers/bin:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/bin:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/cuda/bin:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/mpi/bin:$PATH''')
...
RUN apt-get update -y && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
        ...
        openssh-client && \
    rm -rf /var/lib/apt/lists/*
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.11/REDIST/compilers/lib/* /opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/lib/
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/mpi /opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/mpi
ENV LD_LIBRARY_PATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/mpi/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/compilers/lib:$LD_LIBRARY_PATH \
    PATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.11/comm_libs/mpi/bin:$PATH''')
    ...
    def test_runtime_centos(self):
        ...
        n = nvhpc(eula=True, mpi=False,
                  redist=['comm_libs/11.8/nccl/lib/libnccl.so',
                          'compilers/lib/*',
                          'math_libs/11.8/lib64/libcufft.so.10',
                          'math_libs/11.8/lib64/libcublas.so.11'],
                  version='25.3')
        r = n.runtime()
        self.assertMultiLineEqual(r,
r'''# NVIDIA HPC SDK
RUN yum install -y \
        ...
        openssh-clients && \
    rm -rf /var/cache/yum/*
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/REDIST/comm_libs/11.8/nccl/lib/libnccl.so /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/comm_libs/11.8/nccl/lib/libnccl.so
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/REDIST/compilers/lib/* /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/compilers/lib/
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/REDIST/math_libs/11.8/lib64/libcufft.so.10 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/math_libs/11.8/lib64/libcufft.so.10
COPY --from=0 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/REDIST/math_libs/11.8/lib64/libcublas.so.11 /opt/nvidia/hpc_sdk/Linux_x86_64/25.3/math_libs/11.8/lib64/libcublas.so.11
ENV LD_LIBRARY_PATH=/opt/nvidia/hpc_sdk/Linux_x86_64/25.3/comm_libs/11.8/nccl/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.3/compilers/lib:/opt/nvidia/hpc_sdk/Linux_x86_64/25.3/math_libs/11.8/lib64:$LD_LIBRARY_PATH''')
