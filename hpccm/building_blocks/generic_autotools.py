...
class generic_autotools(bb_base, hpccm.templates.ConfigureMake,
    ...
    compressed_file: Path to the source compressed file (zip or tarball)
    ...
    url: The URL of the compressed file (tarball or zip file) package to build.  
    One of this parameter or the `compressed_file` or `repository` parameters must be
    specified.
