...
class nvhpc(bb_base, hpccm.templates.downloader, hpccm.templates.envvars,
    ...
    def __init__(self, **kwargs):
        ...
        self.__version = kwargs.get('version', '25.11')
        ...
        if Version(self.__version) >= Version('25.11'):
            self.__cuda_version_default = '13.0'
        elif Version(self.__version) >= Version('25.5'):
            self.__cuda_version_default = '12.9'
        elif Version(self.__version) >= Version('25.3'):
            self.__cuda_version_default = '12.8'
        elif Version(self.__version) >= Version('24.9'):
            self.__cuda_version_default = '12.6'
        elif Version(self.__version) >= Version('24.7'):
